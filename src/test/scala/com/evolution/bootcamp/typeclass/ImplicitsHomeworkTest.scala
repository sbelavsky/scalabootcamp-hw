...
import com.evolution.bootcamp.typeclass.ImplicitsHomework.SuperVipCollections4s._
import com.evolution.bootcamp.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax._
import com.evolution.bootcamp.typeclass.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import com.evolution.bootcamp.typeclass.ImplicitsHomework.SuperVipCollections4s._
          |import com.evolution.bootcamp.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import com.evolution.bootcamp.typeclass.ImplicitsHomework.MyTwitter._
